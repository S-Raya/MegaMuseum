<%-- 
    Document   : Home
    Created on : 10 Dec 2024, 21.01.15
    Author     : raya
--%>
...
<body>
        ...
        <div class="overlay" id="menuOverlay">
            <div class="menu-content">
                ...
                <ul>
                    ...
                    <li><a href="Ticket.jsp">Buy Online Ticket</a></li>
                    <li><a href="viewObject.jsp">Online Obyek Display</a></li>
                    <li><a href="Article.jsp">Article Collection</a></li>
    ...
    <% 
        ...
        Double megaWallet = (Double) session.getAttribute("megaWallet");        
        if (username != null) { 
            %> 
                <p>Anda berhasil login sebagai <%= username %>.</p> 
                <% if ("visitor".equals(userType)) { %> 
                    <p>Saldo Mega Wallet anda : <%= megaWallet %>.</p> 
                <% } %>
